...
public class ShowTipsBuilder {
	...
	public ShowTipsBuilder setImageSource(int res){
		showtipsView.setImageRes(res);
		return this;
	}
	...
	public ShowTipsBuilder setListen(BackFirst backFirst){
		showtipsView.setListen(backFirst);
		return this;
	}
