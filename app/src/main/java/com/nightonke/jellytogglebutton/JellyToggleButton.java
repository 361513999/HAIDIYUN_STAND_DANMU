...
//    }
    ...
    public void setCheckedImmediately(boolean checked) {
        setCheckedImmediately(checked, false);
    }
    ...
    public void setLeftBackgroundColorRes(Context context,int res) {
        setLeftBackgroundColor(	context.getResources().getColor(res));
    }
    ...
    public void setRightBackgroundColorRes(Context context,int res) {
        setRightBackgroundColor(	context.getResources().getColor(res));
    }
    ...
    public void setBackgroundColorRes(Context context,int res) {
    
        setBackgroundColor(	context.getResources().getColor(res));
    }
    ...
    public void setLeftThumbColorRes(Context context,int res) {
    	
        setLeftThumbColor(	context.getResources().getColor(res));
    }
    ...
    public void setRightThumbColorRes(Context context,int res) {
        setRightThumbColor(	context.getResources().getColor(res));
    }
    ...
    public void setThumbColorRes(Context context,int res) {
        setThumbColor(	context.getResources().getColor(res));
    }
    ...
    public void setLeftTextColorRes(Context context,int res) {
        setLeftTextColor(	context.getResources().getColor(res));
    }
    ...
    public void setRightTextColorRes(Context context,int res) {
        setRightTextColor(	context.getResources().getColor(res));
    }
    ...
    public void setTextColorRes(Context context,int res) {
        setTextColor(	context.getResources().getColor(res));
    }
