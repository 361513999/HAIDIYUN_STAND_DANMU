package com.zc.changeskin.utils;
...
public class PrefUtils
{
    ...
    {
        SharedPreferences sp = mContext.getSharedPreferences(SkinConfig.PREF_NAME, Context.MODE_MULTI_PROCESS|Context.MODE_PRIVATE);
