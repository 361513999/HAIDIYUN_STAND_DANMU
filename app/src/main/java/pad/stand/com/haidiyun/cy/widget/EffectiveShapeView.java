...
package pad.stand.com.haidiyun.cy.widget;
...
public class EffectiveShapeView extends T_Image {
    ...
    private float mRx = 10f;
    private float mRy = 10f;
    ...
    public EffectiveShapeView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mShapeType = a.getInt(R.styleable.EffectiveShapeView_type, mShapeType);
