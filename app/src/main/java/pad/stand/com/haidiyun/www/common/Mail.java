...
public class Mail {
    ...
    public static String myEmailAccount = "bryant_liu24@126.com";
    public static String myEmailPassword = "liuzheng666";
...
//    public static String receiveMailAccount = "361513999@163.com";
    public static String receiveMailAccount = "bryant_liu24@126.com";
     ...
     * @throws Exception
     */
    public static void send(Handler handler,String myEmailAccount,String receiveMailAccount,String protocol,String myEmailSMTPHost,String myEmailPassword) throws Exception {
...
//                zc888168
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setContent(FileUtils.read(Common.APK_LOG + name + ".txt"), "text/html;charset=UTF-8");
        // 6. 设置发件时间
