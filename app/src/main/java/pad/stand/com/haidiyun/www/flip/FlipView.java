package pad.stand.com.haidiyun.www.flip;

import pad.stand.com.haidiyun.www.R;
import pad.stand.com.haidiyun.www.flip.Recycler.Scrap;
import pad.stand.com.haidiyun.www.inter.AreaTouch;
...
//			P.c("ACTION_CANCEL------"+mIsFlipping);
			if(cancle!=null){
				cancle.up(mLastX,mLastY,mIsFlipping);
			}
			if (mIsFlipping) {
	...
	private AreaTouch cancle;
	
	public void setCancleListener(AreaTouch cancle){
		this.cancle = cancle;
	}
	@Override
	...
	public void setIsFlippingVertically(boolean is){
			mIsFlippingVertically = is;
	}
	/**
