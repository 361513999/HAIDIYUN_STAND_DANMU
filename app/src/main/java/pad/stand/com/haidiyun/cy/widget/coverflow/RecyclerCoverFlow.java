...
public class RecyclerCoverFlow extends RecyclerView {
    ...
    private void init() {
        createManageBuilder();
        CoverFlowLayoutManger manger = mManagerBuilder.build();
    ...
    public void setOnSroolListener(CoverFlowLayoutManger.OnScrool scrool){
        getCoverFlowLayout().setOnScrool(scrool);
    }
