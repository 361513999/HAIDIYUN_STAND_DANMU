package pad.stand.com.haidiyun.www.slide;
...
import pad.stand.com.haidiyun.www.inter.SliderDo;
import pad.stand.com.haidiyun.www.slide.SliderTypes.BaseSliderView;
import pad.stand.com.haidiyun.www.widget.slide.Animations.BaseAnimationInterface;
import pad.stand.com.haidiyun.www.widget.slide.Indicators.PagerIndicator;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.AccordionTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.BackgroundToForegroundTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.BaseTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.CubeInTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.DefaultTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.DepthPageTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.FadeTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.FlipHorizontalTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.FlipPageViewTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.ForegroundToBackgroundTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.RotateDownTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.RotateUpTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.StackTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.TabletTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.ZoomInTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.ZoomOutSlideTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Transformers.ZoomOutTransformer;
import pad.stand.com.haidiyun.www.widget.slide.Tricks.FixedSpeedScroller;
import pad.stand.com.haidiyun.www.widget.slide.Tricks.InfinitePagerAdapter;
import pad.stand.com.haidiyun.www.widget.slide.Tricks.InfiniteViewPager;
import pad.stand.com.haidiyun.www.widget.slide.Tricks.ViewPagerEx;
...
public class SliderLayout extends RelativeLayout{
    ...
    private SliderDo sliderDo;
    public void setDo(SliderDo sliderDo){
    	this.sliderDo = sliderDo;
    }
    /**
     * pause auto cycle.
     */
    ...
    public void moveNextPosition(boolean smooth) {
        ...
        if(this.getCurrentPosition()<laster){
        	//
        	this.stopAutoCycle();
        	sliderDo.end();
        	return;
        }
        P.c("播放图片"+this.getCurrentPosition());
        laster = this.getCurrentPosition();
        mViewPager.setCurrentItem(mViewPager.getCurrentItem() + 1, smooth);
    }
