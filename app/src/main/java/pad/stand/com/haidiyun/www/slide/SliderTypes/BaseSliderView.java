package pad.stand.com.haidiyun.www.slide.SliderTypes;
...
public abstract class BaseSliderView {
     ...
     */
    //public 改成 private
    private BaseSliderView image(String url){
    ...
    private BaseSliderView image(int res){
    ...
    protected void bindEventAndShow(final View v, ImageView targetImageView){
        ...
        Glide.with(BaseApplication.application).load(mFile).asBitmap().diskCacheStrategy(DiskCacheStrategy.RESULT).into(targetImageView);
