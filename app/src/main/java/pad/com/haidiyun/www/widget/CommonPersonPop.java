...
public class CommonPersonPop {
	...
	private void load(int num){
		...
		String post = "{\"TableNo\":\""+tableCode+"\",\"GstCount\":"+num+",\"DeviceSerialNo\":\"" + Common.SER+"\",\"GstSrc\":\"\",\"Waiter\":\"\",\"Remark\":\"\",\"User\":\""+optName+"\",\"ClientType\":\"Android\",\"ClientMac\":\""+ FileUtils.getDeviceId()+"\"}";
		P.c(post);
