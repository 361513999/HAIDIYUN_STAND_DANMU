...
public class DisAdapter extends BaseAdapter {
	...
	private ArrayList<Dis> menuBeans;
	private Context context;

	public DisAdapter(Context context, ArrayList<Dis> menuBeans) {
	...
	public void updata(ArrayList<Dis> menuBeans) {
		this.menuBeans = menuBeans;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final Dis obj = menuBeans.get(position);
